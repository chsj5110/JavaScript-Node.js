...
const firstBtnElement = document.querySelector('button');   // querySelector : 첫 요소 선택
const secondBtnElement = document.getElementById('second-button');
...
// firstBtnElement.addEventListener('click', firstButton);
// secondBtnElement.addEventListener('click', secondButton);
